...
public class Territories {
    ...
    public Territory[] getTerritories() {
        ...
        Territory t1 = new Territory("Afghanistan", 0);
        Territory t2 = new Territory("Alaska",1);
        Territory t3 = new Territory("Alberta",2);
        Territory t4 = new Territory("Argentina",3);
        Territory t5 = new Territory("Brazil",4);
        Territory t6 = new Territory("Central America",5);
        Territory t7 = new Territory("China",6);
        Territory t8 = new Territory("Central Africa",7);
        Territory t9 = new Territory("East Africa",8);
        Territory t10 = new Territory("Eastern Australia",9);
        Territory t11 = new Territory("Eastern United States",10);
        Territory t12 = new Territory("Egypt",11);
        Territory t13 = new Territory("Great Britain",12);
        Territory t14 = new Territory("Greenland",13);
        Territory t15 = new Territory("Iceland",14);
        Territory t16 = new Territory("India",15);
        Territory t17 = new Territory("Indonesia",16);
        Territory t18 = new Territory("Irkutsk",17);
        Territory t19 = new Territory("Japan",18);
        Territory t20 = new Territory("Kamchatka",19);
        Territory t21 = new Territory("Madagascar",20);
        Territory t22 = new Territory("Middle East",21);
        Territory t23 = new Territory("Mongolia",22);
        Territory t24 = new Territory("New Guinea",23);
        Territory t25 = new Territory("North Africa",24);
        Territory t26 = new Territory("Northwest Territory",25);
        Territory t27 = new Territory("Northern Europe",26);
        ...
        Territory t35 = new Territory("Southern Europe",34);
        Territory t36 = new Territory("Ukraine",35);
        Territory t37 = new Territory("Ural",36);
        Territory t38 = new Territory("Venezuela",37);
        Territory t39 = new Territory("Western Australia",38);
        Territory t40 = new Territory("Western Europe",39);
        Territory t41 = new Territory("Western United States",40);
        Territory t42 = new Territory("Yakutsk",41);
